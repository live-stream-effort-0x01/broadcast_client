...
import { ImTv } from 'solid-icons/im'
  ...
  return (
    <div class='card-wapper'>
     <div class='card-image'>
        <img alt='' src={img? img :'https://cdn.tuoitre.vn/thumb_w/640/2021/9/23/maxresdefault-1632364307368131537391.jpeg'}></img>
    ...
    <div class='card-title'>
        ...
        <p class='dot'></p>
        <p class='card-seri'>{icon ?  icon:<TbMovie />} {seri?seri:'Movie'}</p>
        <p class='dot'></p>
